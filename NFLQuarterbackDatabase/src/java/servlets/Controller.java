...
public class Controller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equalsIgnoreCase("home")) {
            ...
            String yardsString = request.getParameter("yards");

            // validate and convert isbn string into a double
            if (yardsString == null || yardsString.isEmpty()) {
                yards = 0;
            } else {
                yards = Double.parseDouble(yardsString);
            }

            // store data in an Employee object
            Employee employee = new Employee(0, lastName, firstName, team, yards);

            // validate the parameters
            if (lastName == null || firstName == null || team == null
                    || yardsString == null || lastName.isEmpty()
                    || firstName.isEmpty() || team.isEmpty()
                    || yardsString.isEmpty()) {
            ...
            // validate and convert yards string into a double
            if (yardsString == null || yardsString.isEmpty()) {
                yards = 0;
            } else {
                yards = Double.parseDouble(yardsString);
            ...
            // store data in an Employee object
            Employee employee = new Employee(empId, lastName, firstName, team, yards);

            // validate the parameters
            if (empIdString == null || lastName == null || firstName == null
                    || team == null || yardsString == null
